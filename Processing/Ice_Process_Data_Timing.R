...
## output to csv files
# raw data
ofile <- "~/Projects/ICES_6IZPS_PP/outputs/Ice_Timing/Ice_Timing_Data_Raw.csv"
...
# filtered data
ofile <- "~/Projects/ICES_6IZPS_PP/outputs/Ice_Timing/Ice_Timing_Data_Filtered.csv"
...
# climatology
ofile <- "~/Projects/ICES_6IZPS_PP/outputs/Ice_Timing/Ice_Timing_Climatology.csv"
write.table(df_climatology_mean_w,
            file=ofile, append=FALSE, quote=TRUE, sep=",",
            eol="\n", na="NA", dec=".", row.names=FALSE, col.names=TRUE)

# anomalies
ofile <- "~/Projects/ICES_6IZPS_PP/outputs/Ice_Timing/Ice_Timing_Anomalies_Annual.csv"
write.table(df_anomaly_mean_annual_w,
            file=ofile, append=FALSE, quote=TRUE, sep=",",
            eol="\n", na="NA", dec=".", row.names=FALSE, col.names=TRUE)

# normalized anomalies
ofile <- "~/Projects/ICES_6IZPS_PP/outputs/Ice_Timing/Ice_Timing_Normalized_Anomalies_Annual.csv"
...
##--------------------------------------------------------------------------------------------
## save to RData file
ofile <- "~/Projects/ICES_6IZPS_PP/outputs/Ice_Timing/Ice_Timing.RData"
